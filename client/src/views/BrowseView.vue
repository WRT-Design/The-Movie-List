        ...
        <div v-if="movie" class="modal-body">
          ...
          <section>
            <div v-if="simple" class="form-group">
              ...
              <input type="range" class="form-range" min="1.0" max="5.0" step="0.5" id="rating" v-model="movieStars"></input>
            </div>
            <div v-if="!simple" class="form-group">
              <div>
                <label class="d-flex justify-content-between" for="acting">
                  ...
                  <span>
                    ...
                    <FontAwesomeIcon class="starIcon"icon="fa-bold fa-star" v-if="ratings.acting >= 2" />
                    <FontAwesomeIcon class="starIcon"icon="fa-bold fa-star-half-stroke" v-else-if="ratings.acting >= 1.5" />
                    <FontAwesomeIcon class="starIcon"icon="fa-regular fa-star" v-else />

                    <FontAwesomeIcon class="starIcon"icon="fa-bold fa-star" v-if="ratings.acting >= 3" />
                    <FontAwesomeIcon class="starIcon"icon="fa-bold fa-star-half-stroke" v-else-if="ratings.acting >= 2.5" />
                    <FontAwesomeIcon class="starIcon"icon="fa-regular fa-star" v-else />

                    <FontAwesomeIcon class="starIcon"icon="fa-bold fa-star" v-if="ratings.acting >= 4" />
                    <FontAwesomeIcon class="starIcon"icon="fa-bold fa-star-half-stroke" v-else-if="ratings.acting >= 3.5" />
                    <FontAwesomeIcon class="starIcon"icon="fa-regular fa-star" v-else />

                    <FontAwesomeIcon class="starIcon"icon="fa-bold fa-star" v-if="ratings.acting >= 5" />
                    <FontAwesomeIcon class="starIcon"icon="fa-bold fa-star-half-stroke" v-else-if="ratings.acting >= 4.5" />
                    <FontAwesomeIcon class="starIcon"icon="fa-regular fa-star" v-else />
              ...
              <div>
                <label for="dialogue">Dialogue: {{ ratings.dialogue }}</label
                ><input
                  id="dialogue"
                  class="form-range"
                  name="dialogue"
              ...
              <div>
                <label for="directing">Directing: {{ ratings.directing }}</label
                ><input
                  id="directing"
                  class="form-range"
                  name="directing"
            ...
            <div class="form-group">
              <label for="comment"><h3>Your Review</h3></label>
              <textarea
                class="form-control"
                id="comment"
